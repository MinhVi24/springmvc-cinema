...
<body class="d-flex flex-row justify-content-center">
	...
	<div class="main-body row col-12 d-flex flex-row justify-content-center">
		...
		<h2 class="text-center"> THỐNG KÊ DOANH THU NGÀY ${ngay}</h2>
			...
			<label for="input-1" class="col-1">Chọn ngày :</label>
			...
			<h2 class="text-end"> Tổng doanh bán vé ngày ${ngay}: <fmt:formatNumber value="${tongDoanhThuBanVe }" pattern="#,##0"/> VNĐ</h2>
			<p>${noInfo }</p>
			...
			<h2 class="text-end"> Tổng doanh dịch vụ ngày ${ngay}: <fmt:formatNumber value="${tongDoanhThuDichVu }" pattern="#,##0"/> VNĐ</h2>
			<p>${noInfo }</p>
		</div>
	</div>
